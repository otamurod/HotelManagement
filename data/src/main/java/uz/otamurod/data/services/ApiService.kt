package uz.otamurod.data.services
...
interface ApiService {
    ...
    suspend fun getHotel(): Response<uz.otamurod.domain.model.Hotel>

    @GET("/v3/f9a38183-6f95-43aa-853a-9c83cbb05ecd")
    suspend fun getHotelRooms(): Response<uz.otamurod.domain.model.Rooms>

    @GET("/v3/e8868481-743f-4eb2-a0d7-2bc4012275c8")
    suspend fun getBookingInfo(): Response<uz.otamurod.domain.model.Booking>
}